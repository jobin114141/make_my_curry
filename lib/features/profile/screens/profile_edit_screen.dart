...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Selector<VerificationProvider, bool>(
                                    selector: (context, verificationProvider) =>
                                    ...
                                    builder: (context, isLoading, child) {
                                      return CustomTextFieldWidget(
                                        ...
                                        isToolTipSuffix: AuthHelper
                                                    .isEmailVerificationEnable(
                                                        config) &&
                                                _emailController!
                                                    .text.isNotEmpty
                                            ? true
      ...
      await profileProvider.getUserInfo(true, isUpdate: false).then((_) {
        ...
        if (profileProvider.userInfoModel?.phone?.isNotEmpty ?? false) {
          ...
          _phoneController?.text = PhoneNumberCheckerHelper.getPhoneNumber(
              profileProvider.userInfoModel?.phone ?? '', countryCode ?? '')!;
  ...
  Future<void> _onSubmit() async {
    ...
    bool isPhoneValid =
        PhoneNumberCheckerHelper.isPhoneValidWithCountryCode(phoneNumber);
